locals {
    ...
    LOCAL_EXECUTE_VAR = {
        ANSIBLE_CONF_FILE_PATH = "${ANSIBLE_DIR_PATH}/0.CONFIG/ansible.cfg"
        ANSIBLE_HOST_FILE_PATH = "${ANSIBLE_DIR_PATH}/0.CONFIG/hosts"
        ANSIBLE_PLAYBOOK_APPLY_DIR_PATH = "${ANSIBLE_DIR_PATH}/1.PLAYBOOK_APPLY"
        ANSIBLE_PLAYBOOK_DESTROY_DIR_PATH = "${ANSIBLE_DIR_PATH}/2.PLAYBOOK_DESTROY"
