...
AWS_VPC0_Za_PUB_SN_CIDRs = ["10.10.10.0/24"]
...
AWS_INS_VOL_DIRs = ["/dev/xvda"]
AWS_INS_VOL_SIZEs = [8]
AWS_INS_VOL_TYPEs = ["gp2"]
AWS_INS_UDs_FILEs = [
    [
        "../04.EC2_USER_DATA/user_data_ubuntu_2204_permission.sh",
        "../04.EC2_USER_DATA/user_data_ubuntu_2204_create_new_user.sh",
        "../04.EC2_USER_DATA/user_data_ubuntu_2204_nat.sh",
        "../04.EC2_USER_DATA/user_data_ubuntu_2204_avoid_gui_interface.sh",
        "../04.EC2_USER_DATA/user_data_ubuntu_2204_reinstall_dpkg.sh"
    ]
]
